  ...
  return (
    <div className="main-frame">
      ...
      <div className="letssail-creativity-frame">
        <div className="lets-sail-the">Let’s sail the sea of creativity</div>
      </div>
      ...
      <main className="frame-frame-maskgroup-socialli">
        <section className="text-unleash-design-agency">
          ...
          <div className="frame-frame-maskgroup-social-m">
            ...
            <div className="design-agency-website">Design agency website</div>
          </div>
        </section>
        ...
        <section className="selected-works">
          ...
          <div className="infinite-creativity">
            ...
            <div className="this-is-our">
              This is our selected work from our large portfolio and we also
              keep adding our precious things here, by the time you can also
              check at dribbble and behance.
            </div>
          </div>
