    ...
    <div className="marasih-home-page">
      <div>
        {isMobile ? (
          ...
          //                         <i className="fa-solid fa-arrow-right arrow-top-left"></i>
          //                       </button>
          //                       <button className="circle-button2" onClick={handleNext}>
          //                         <i className="fa-solid fa-arrow-right arrow-top"></i>
          //                       </button>
          //                     </div>
          //                   </div>
          ...
          //                             <i className="fa-solid fa-arrow-right arrow-icon-1"></i>
          //                           </div>
          //                         </div>
          //                       </div>
          ...
          //                         <i className="fa-solid fa-arrow-right mobile-arrow-icon-1"></i>
          //                       </div>
          //                     </div>
          //                   </div> */}
          ...
          <div className="mobile-home-page">
            <div className="home-page">
              <section className="design-that-inspires-connects-parent">
                <div className="design-that-inspires-container">
                  <span>Design that Inspires, Connects, & </span>
                  <span className="sparks-growth">Sparks Growth</span>
                </div>
                <div className="frame-wrapper">
                  <div className="frame-parent">
                    <div className="frame-group">
                      ...
                      <div className="sibling-connection">
        <div className="rooted-subtree"></div>
        {/* Clickable icon to toggle offcanvas menu */}
        <img
          className="essetionalmenu-icon"
          loading="lazy"
          alt=""
      ...
      {/* Render the OffcanvasMenu component */}
                    </div>
                    <div className="tree-vertex">
                      <div className="ancestor-pathway">
                        <div className="ancestor-pathway-child"></div>
                        <b className="we-marasih-studio">We marasih studio</b>
                      </div>
                    </div>
                  </div>
              ...
              <section className="forest-fragment">
                <div className="rectangle-parent">
                  <div className="frame-child"></div>
                  <button
                    className="subtree-roots-connection-parent"
                    onClick={() => navigate("/contact#main")}
                  >
                    <div className="subtree-roots-connection">
              ...
              <section className="subtree-network">
                <div className="leaf-interconnect">
                  <div className="leaf-interconnect-child"></div>
                  {/* <div className="subtree-roots-graph"> */}
                  <div className="">
                    <div className="subtree-roots-graph-inner">
                      <div className="frame-container">
                        <div className="crafted-with-care-wrapper">
                          <div className="crafted-with-care">
                            Crafted with Care
                          </div>
                        </div>
                        <div className="crafted-with-precision-container">
                          <span>Crafted with Precision, </span>
                          <span className="infused-with-passion">
                            Infused with Passion
                          </span>
                    ...
                    {/* <div className="rectangle-group">
                      ...
                      <div className="input-receiver">
                        <div className="input-receiver-child"></div>
                        ...
                        <img
                          className="input-receiver-item"
                          loading="lazy"
                          alt=""
                          src="/group-34354@2x.png"
                        />
                      </div>
                  ...
                  {/* <div className="group-div">
                    ...
                    <img
                      ...
                      loading="lazy"
                      alt=""
                      src="/group-34469@2x.png"
                    />

                    <div className="rooted-subtrees">
                      <div className="rooted-subtrees-child"></div>
                      <div className="dor-dating">Dor - Dating app</div>
                      <div className="sibling-distance-matrix">
                        <div className="design-system-ux">
                          Design system, UX research & UI design
                        </div>
                      </div>
                      <img
                        className="rooted-subtrees-item"
                        loading="lazy"
                        alt=""
                        src="/group-34358@2x.png"
                      />
                    </div>
                  </div> */}
                  {/* <div className="group-div">
                  ...
                  <div className="rectangle-parent1">
                    ...
                    <div className="frame-div">
                      ...
                      <div className="panache">panache</div>
                      <div className="logo-brand-identity-wrapper">
                        <div className="logo-brand">Logo & Brand identity</div>
                      </div>
                      <img
                        className="frame-child4"
                        loading="lazy"
                        alt=""
                        src="/group-34359@2x.png"
                      />
                    </div>
                  </div>
                  <div className="rectangle-parent1">
                  ...
                  <div className="rectangle-parent2">
                    ...
                    <div className="rectangle-parent3">
                      ...
                      <h2 className="see-our-whole-container">
                        <p className="see-our">See our</p>
                        <p className="whole-portfolio">whole portfolio</p>
                      </h2>
                      <img
                        className="frame-child7"
                        alt=""
                        src="/group-34359-1@2x.png"
                      />
                    </div>
                  </div>
                </div>
              ...
              <div className="services-custom-mobile">
                <section class="geometry-transformer">
                  <div class="rectangle-parent4">
                    <div class="frame-child8"></div>
                    <div class="rows"></div>
                    <div class="tables-wrapper">
                      <div class="tables">
                        <div class="design-beyond-boundaries-wrapper">
                          <div class="design-beyond-boundaries">
                            Design Beyond Boundaries
                          </div>
                        </div>
                        <div class="elevate-with-exceptional-container">
                          <span>Elevate with Exceptional </span>
                          <span class="design-services">Design Services</span>
                        </div>
                      </div>
                    </div>
                  </div>
              ...
              {/* <section className="geometry-transformer">
                <div className="rectangle-parent4">
                  <div className="frame-child8"></div>
                  <div className="rows"></div>
                  <div className="tables-wrapper">
                    <div className="tables">
                      <div className="design-beyond-boundaries-wrapper">
                        <div className="design-beyond-boundaries">
                          Design Beyond Boundaries
                        </div>
                      </div>
                      <div className="elevate-with-exceptional-container">
                        <span>Elevate with Exceptional </span>
                        <span className="design-services">Design Services</span>
                      </div>
                    </div>
                  </div>
                  <img
                    ...
                    loading="lazy"
                    alt=""
                    src="/group-34379@2x.png"
                  />

                  <div className="rectangle-parent5">
                    <div className="frame-child10"></div>
                    <div className="ux-research1">
                      UX Research & UI Designing
                    </div>
                    <div className="explore-extraordinary-ux-with-wrapper">
                      <div className="explore-extraordinary-ux">
                        Explore extraordinary UX with our research and elevate
                        your brand through stunning UI designs. Join us on a
                        journey where creativity meets seamless functionality,
                        turning your vision into a captivating digital reality
                      </div>
                    </div>
                    <div className="we-provides-parent">
                      ...
                      <div className="frame-parent1">
                        <div className="frame-parent2">
                          ...
                          <div className="ux-research2">UX Research</div>
                        </div>
                        ...
                        <div className="frame-parent4">
                          ...
                          <div className="user-experience-design">
                        ...
                        <div className="frame-parent5">
                          ...
                          <div className="user-interface-design">
                    ...
                    <div className="frame-parent7">
                      <div className="frame-wrapper1">
                        <div className="connected-components-parent">
                          <div className="connected-components">
                            <input
                              className="connected-components-child"
                              checked="{true}"
                              type="radio"
                              name="radioGroup-1"
                            />
                          ...
                          <div className="toolbars">
                            <img
                              className="toolbars-child"
                              alt=""
                              src="/line-39.svg"
                            />

                            <img
                              className="toolbars-item"
                              alt=""
                              src="/line-40.svg"
                            />

                            <img
                              className="toolbars-inner"
                              alt=""
                              src="/line-41.svg"
                            />
                          </div>
              ...
              <section className="home-page-inner">
                <div className="frame-parent8">
                  <div className="frame-parent9">
                    <div className="masters-of-the-digital-canvas-wrapper">
                      <div className="masters-of-the">
                        Masters of the Digital Canvas
                      </div>
                    </div>
                    <div className="siblings-set">
                      <div className="proficiency-amplified-with-container">
                        <span>Proficiency Amplified with </span>
                        <span className="industry-leading-tools">
                          Industry-Leading Tools
                        </span>
                      </div>
                      <div className="ancestor-link">
                        <div className="crafting-excellence-with">
                          Crafting excellence with a toolkit of innovation. Our
                          proficiency spans Figma, Photoshop, Illustrator, Adobe
                          XD, After Effects, and WordPress. Elevate your digital
                          experience with our mastery in these industry-leading
                          tools. From seamless designs to dynamic websites, we
                          bring your vision to life with precision and
                          creativity
                        </div>
                      </div>
                    </div>
                  ...
                  <div className="frame-wrapper2">
                    <button
                      className="connected-components-group"
                      onClick={() => navigate("/contact")}
                    >
                      <div className="connected-components1">
                        <div className="lets-create-a">
              ...
              <section className="iterative-loop">
                <div className="decision-maker">
                  <div className="rectangle-parent6">
                    ...
                    <div className="mask-group">
                      ...
                      <div className="frame-parent10">
                        <div className="digits-of-design-wrapper">
                          <div className="digits-of-design">
                            Digits of Design
                          </div>
                        </div>
                        <div className="unveiling-our-design-universe-wrapper">
                          <h3 className="unveiling-our-design-container">
                            <span>Unveiling Our Design</span>
                            <span className="universe-in-stats">
                              {" "}
                              Universe in Stats
                        ...
                        <div className="our-numbers-tell">
                          Our numbers tell a story of dedication – from a
                          multitude of successful projects and a dynamic team to
                          a growing list of satisfied clients.
                        </div>
                      </div>
                      <div className="mask-group-inner">
                        <button className="frame-button">
                          <div className="lets-craft-your-product-wrapper">
                            <div className="lets-craft-your">
                              Let’s craft your product
                            </div>
                          </div>
                  ...
                  <div className="center-mobile-images">
                    <img className="center-image" src="/projects.png" alt="" />
                    <img className="center-image" src="/client.png" alt="" />
                    <img className="center-image" src="/team.png" alt="" />
                  </div>
                  ...
                  {/* <div className="rectangle-parent9">
                    <div className="frame-child18"></div>
                    <img
                      className="mask-group-icon3"
                      alt=""
                      src="/mask-group-2.svg"
                    ...
                    <div className="frame-wrapper3">
                      <div className="frame-parent14">
                        <div className="rectangle-parent11">
                          ...
                          <div className="frame-child21"></div>
                        </div>
                        <div className="ellipse-div"></div>
                        <div className="darshil-is-a">
                          Darshil is a talented designer and took initiative in
                          building the Ul/UX architecture for our application.
                          He is quick and his attention to detail and general Ul
                          creativity is great. I recommend him highly for any
                          project in UI/UX design.
                        </div>
                      </div>
                  ...
                  <div className="frame-wrapper4">
                    <div className="ellipse-parent">
                      ...
                      <div className="frame-wrapper5">
                        <div className="arpit-bajpai-parent">
                          <div className="arpit-bajpai">Arpit Bajpai</div>
                          <div className="co-founder-cto">
                            Co-Founder & CTO at LegalAI
                          </div>
                        </div>
                      </div>
                    </div>
              ...
              <section className="frame-section">
                <div className="frame-parent15">
                  <div className="frame-parent16">
                    <div className="glimpses-of-gratification-wrapper">
                      <div className="glimpses-of-gratification">
                        Glimpses of Gratification
                      </div>
                    </div>
                    <div className="unwavering-praise-for-our-digi-parent">
                      <div className="unwavering-praise-for-container">
                        <span>Unwavering Praise for Our </span>
                        <span className="digital-design-expertise">
                          Digital Design Expertise
                        </span>
                      </div>
                      <div className="captivating-user-experiences-wrapper">
                        <div className="captivating-user-experiences">
                          Captivating User Experiences, Unwavering Brand
                          Loyalty. Discover the impact of our meticulously
                          crafted designs, from evoking awe-inspiring user
                          experiences to fostering unwavering brand loyalty. Let
                          our clients' stories serve as a testament to our
                  ...
                  <div className="frame-wrapper6">
                    <button
                      ...
                      onClick={() => navigate("/contact#main")}
                    >
                      <div className="lets-create-phenomenal-wrapper">
                        <div className="lets-create-phenomenal">
                          Let’s create phenomenal
                        </div>
                      </div>
              ...
              {/* <section className="home-page-inner1">
                <div className="data-processor-parent">
                  <div className="data-processor"></div>
                  <div className="be-simple-be-creative-wrapper">
                  ...
                  <div className="frame-wrapper7">
                    <div className="frame-parent18">
                      <div className="got-an-idea-wrapper">
                        <div className="got-an-idea">Got an idea?</div>
                      </div>
                      <div className="ellipse-group">
                        <div className="frame-child22"></div>
                        <div className="rectangle-parent12">
                          <div className="frame-child23"></div>
                          <button className="frame-parent19">
                            <div className="lets-get-in-touch-wrapper">
                              <div className="lets-get-in">
                                Let’s get in touch
                              </div>
                            </div>
                            <img
                  ...
                  <div className="marasih-studio-all-rights-res-wrapper">
                    <div className="marasih-studio-all">
                      2024 @ marasih studio. All rights reserved
                    </div>
                  </div>
                ...
                <div>
                  {isMobile ? (
                    <div>
                      <div className="mobile-custom-class">
                        <img
                          className="mini-figma"
                          src="/group-34406@2x.png"
                          alt=""
                        />
                        <img src="/industry-leading.png" alt="" />
                        <a href="/contact" className="frame-elements">
                          <div className="lets-create-a">
                            Let’s create a thing
                          </div>
                          <img
                        ...
                        <div className="frame-background">
                          <div className="frame-border">
                            ...
                            <div className="button-element">
                              ...
                              <div className="crafting-excellence-with">
                                Crafting excellence with a toolkit of
                                innovation. Our proficiency spans Figma,
                                Photoshop, Illustrator, Adobe XD, After Effects,
                                and WordPress. Elevate your digital experience
                                with our mastery in these industry-leading
                                tools. From seamless designs to dynamic
                                websites, we bring your vision to life with
                        ...
                        <div className="crafted-projects">
                          ...
                          <div className="mask-group1">
                            <img
                              ...
                              src="/group-34407@2x.png"
                            />
                            <div className="digits-of-design1">
                              Digits of Design
                            </div>
                            <h2 className="unveiling-our-design-container">
                              <span>Unveiling Our Design</span>
                            ...
                            <div className="our-numbers-tell">
                              Our numbers tell a story of dedication – from a
                              multitude of successful projects and a dynamic
                              team to a growing list of satisfied clients.
                            </div>
                            <button className="lets-craft-your-product-parent">
                              <div className="lets-craft-your">
                                Let’s craft your product
                        ...
                        <div className="successful-delivery">
                          <div className="frame-global-projects">
                            <div className="frame-mask-group">
                              ...
                              <div className="client-projects">
                                ...
                                <div className="project-successfully-delivered">
                                  <div className="project">Project</div>
                                  <div className="successfully-delivered-project">
                                    successfully delivered projects around the
                                    globe
                                  </div>
                                </div>
                                <img
                            ...
                            <div className="frame-mask-group1">
                              ...
                              <div className="frame-client-services">
                                <div className="clients">Clients</div>
                                <div className="successfully-served-services">
                                  successfully served services clients around
                                  the globe
                                </div>
                              </div>
                            </div>
                          ...
                          <div className="gratification-glimpses">
                            ...
                            <div className="captivating-user-experiences1">
                              <div className="team-members">Team members</div>
                              <div className="creative-and-beautiful">
                                Creative and beautiful team of peoples to
                                upscale product and scale your product
                              </div>
                            </div>
                          </div>
                        </div>
                        ...
                        <div className="designer-frame">
                          ...
                          <div className="co-founder-c-t-o-ellipse">
                            <div className="digital-design-expertise-parent">
                              ...
                              <div className="gratification-glance-frame" />
                              <div className="darshil-is-a">
                                Darshil is a talented designer and took
                                initiative in building the Ul/UX architecture
                                for our application. He is quick and his
                                attention to detail and general Ul creativity is
                                great. I recommend him highly for any project in
                                UI/UX design.
                              </div>
                            </div>
                            <img
                          ...
                          <div className="frame-glob-projects">
                            <div className="team-members-frame">
                              ...
                              <div className="captivating-user-experiences2">
                                ...
                                Loyalty. Discover the impact of our meticulously
                                crafted designs, from evoking awe-inspiring user
                                experiences to fostering unwavering brand
                                loyalty. Let our clients' stories serve as a
                                testament to our unwavering commitment to design
                                excellence.
                              </div>
                            </div>
                            <button className="lets-create-phenomenal-parent">
