          ...
          <header className="first-mask-group">
            ...
            <div className="third-frame">
              <div className="frame-footer-home">
                ...
                <a href="/" className="about3-home">Home</a>
              </div>
              <a href="/about" className="about1">About</a>
              <a href="/contact" className="contact-us2">Contact us</a>
                ...
                <div className="crafted-box">
                  ...
                  <div className="crafted-inner">
                    <div className="services-desc">
                      ...
                      <div className="crafted-card-small-text"> UX research and UI design</div>
                    </div>
                  </div>
                  <div className="outlined-circle">
                    <i class="fa-solid fa-arrow-right arrow-icon-1"></i>
          ...
          <div className="slider-container">
            <div className="slider">
              <Slider ref={slider1} {...sliderSettings}>
                <div className="slide"><img src="/services1.png" alt="Service 1" /></div>
                <div className="slide"><img src="/Group 34379.png" alt="Group 34379" /></div>
                <div className="slide"><img src="/services1.png" alt="Service 1" /></div>
              </Slider>
            </div>
            <div className="slider">
 ...
 */}
        ...
        <div className="fixed-container">
          ...
          <div className='circle-button-service'>
            ...
            <button className="circle-button2-ser" onClick={handleNext}>
              <i class="fa-solid fa-arrow-right arrow-top"></i>
