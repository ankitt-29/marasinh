      ...
      <OffcanvasMenu />
                    ...
                    <div className="tree-vertex">
                      <div className="ancestor-pathway">
                        ...
                        <div className="we-marasih-studio">We marasih studio</div>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div className="center-divs">
                <img className="review-image" src="/review-mob.png" alt="" />
              </div>
          ...
          <div className="desktop-home-page">
            <div className="marasih-home-page">
              <div className="header-frame">
                  ...
                  <div>
                    <Slider ref={sliderRef} {...settings}>
                      ...
                      <div className="crafted-container" key={4}>
                        ...
                        <img className="card-4" src="/card-4.png" alt="" />
                      </div>
                    </Slider>
                  </div>
                </div>
                ...
                <img src="/left-side.svg" alt="Background Image" class="background-image"/> 
                  ...
                  {isMobile ? (
                    ...
                    <div>
                      ...
                      <section className="designer-frame-parent">
                        <img className="review-desktop" src="/review-desktop.png" alt="" />
