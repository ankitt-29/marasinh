    ...
    <div className="desktop-work-page">
      <header className="inner-frame-a">
        ...
        <div className="contact-us-frame1">
          <div className="about2" onClick={() => handleNavigation("/")}>
            Home
          </div>
          <div className="contact-us4" onClick={() => handleNavigation("/work")}>
            Work
          </div>
          <div className="work-frame">
            <div className="text-layer">
              <div className="ellipse-shape" />
              <div className="work4" onClick={() => handleNavigation("/about")}>
                About Us
              </div>
            </div>
          </div>
