...
const MyComponent = () => {
  useEffect(() => {
    ...
    // Clean up function to remove the <link> element when component unmounts
    return () => {
  ...
  return (
    <div>
 <div className="my-custom-contact">
    <div className="contact-us1">
      <div className="wrapper-star-1">
        <img className="wrapper-star-1-child" alt="" src="./public/star-1.svg" />
      </div>
      <div className="wrapper-star-2">
        <img className="wrapper-star-2-child" alt="" src="./public/star-1.svg" />
      </div>
        ...
        <div className="dropdown-menu">
                ...
                <div className="rectangle-parent13">
                  ...
                  <div className="frame-parent24">
                    <div className="lets-create-magic-wrapper">
                      <div className="lets-create-magic">Let’s create magic</div>
                    </div>
          ...
          <form className="group-form">
            ...
            <div className="lets-create-special-parent">
              <b className="lets-create-special">Let’s create special</b>
              ...
              <button className="group-button">
                <div className="frame-child30"></div>
                <div className="your-organisation-name">Your organisation name</div>
              </button>
            </div>
            ...
            <div className="feature-extractor">
              <div className="vector-parent">
                <img
                  ...
                  alt=""
                  src="./public/rectangle-5899.svg"
                />

                <div className="write-about-your">
                  Write about your project (Project name, scope of work,
                  timeline, budget)*
                </div>
              </div>
            </div>
          ...
          <div className="rectangle-parent27">
            ...
            <div className="figma-workspace-wrapper">
              <div className="figma-workspace">
                ...
                <div className="marasihstudiogmailcom">marasihstudio@gmail.com</div>
              </div>
            </div>
      ...
      <section className="group-section">
        <div className="ellipse-parent3">
          ...
          <img className="frame-child46" alt="" src="./public/rectangle.png" />
        </div>
