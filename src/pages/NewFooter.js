...
export default function NewFooter() {
  ...
  return (
    ...
    <div className='new-footer-css'>
         <section className="ellipse-parent16">
        <div className="frame-child193"></div>
        <div className="frame-child194"></div>
        <div className="be-simple-be-creative-group">
          {/* <h1 className="be-simple-be-container7">
            <p className="be-simple7">BE SIMPLE.</p>
            <p className="be-creative7">BE CREATIVE.</p>
          </h1> */}
  <img
              className="simple-mini"
              src="/BE SIMPLE. BE CREATIVE..png"
            ></img>          <div className="frame-wrapper49">
            <div className="frame-parent92">
              <div className="got-an-idea-
              ">
                <div className="got-an-idea7">Got an idea?</div>
              </div>
              <div className="button-container2">
                  <a href="#" className="magic-button2">
                    <span className="submit-text" style={{ color: "#525252" }}>
                      Let’s get in touch
                    </span>{" "}
        ...
        <div className="data-aggregator3">
          <div className="shape-collection1"></div>
        </div>
        <div className="frame-wrapper50">
          <div className="frame-parent93">
            <div className="frame-wrapper51">
              <div className="frame-parent94">
                <div className="ellipse-parent17">
                  <div className="frame-child196"></div>
                  <img
                    className="layer-1-icon18"
                    alt=""
                    src="/layer-1-2.svg"
                  />
                </div>
                <div className="design-studio7">Design Studio</div>
              </div>
            </div>
            <div className="explore-parent3">
              <div className="explore7">Explore</div>
              <div className="work-parent3">
                <div className="work10">Work</div>
                <div className="about-us10">About us</div>
                <div className="blogs11">Blogs</div>
                <div className="contact-us12">Contact us</div>
              </div>
            </div>
            <div className="frame-parent95">
              <div className="follow-us-group">
                <div className="follow-us11">Follow us</div>
                {/* <div className="social-icons-parent3">
                  <img
                    className="social-icons40"
                    loading="lazy"
                    alt=""
...
>
  ...
  <div className="pink-round1"></div>
              ...
              {/* <div className="component-2-group">
                ...
                <img
                  className="social-icons42"
                  alt=""
                  src="/social-icons-21.svg"
                />

                <img
                  className="social-icons43"
                  alt=""
                  src="/social-icons-31.svg"
                />

                <img
                  className="social-icons44"
                  alt=""
                  src="/social-icons-41.svg"
                />

                <img
                  className="frame-child197"
                  loading="lazy"
                  alt=""
                  src="/frame-481.svg"
                />
        ...
        <div className="marasih-studio-all-rights-res-wrapper2">
          <div className="marasih-studio-all7">
